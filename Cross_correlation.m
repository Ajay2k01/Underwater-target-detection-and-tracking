...
%   'NumPathsSource','Property','NumPaths',10,'PropagationSpeed',1500);
% 
% channel1 = phased.MultipathChannel('OperatingFrequency',fc);
% 
% 
% isopaths = phased.IsoSpeedUnderwaterPaths('ChannelDepth',channelDepth,...
%   'NumPathsSource','Property','NumPaths',10,'PropagationSpeed',propSpeed);
% 
% channel2 = phased.MultipathChannel('OperatingFrequency',fc);
